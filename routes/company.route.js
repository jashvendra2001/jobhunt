...
import { companyRegister, getById, getCompany, getCompanyById, updateCompany } from "../controller/company.controller.js"
...
router.route("/getCompanyById/:id").get(isAuthentication,getCompanyById)
